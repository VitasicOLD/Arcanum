...
{                                                           // value1         value2        comment
    ...
    ACHIEVEMENT_CRITERIA_REQUIRE_KNOWN_TITLE           = 22, // title_id                     title
};

#define MAX_ACHIEVEMENT_CRITERIA_DATA_TYPE               23 // maximum value in AchievementCriteriaDataType enum
