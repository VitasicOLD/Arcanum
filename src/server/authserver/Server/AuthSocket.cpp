...
bool AuthSocket::_HandleRealmList()
{
    ...
    if ((_expversion & POST_BC_EXP_FLAG) || (_expversion & POST_WOTLK_EXP_FLAG))                   // 2.x and 3.x clients
    {
        pkt << (uint8)0x10;
        pkt << (uint8)0x00;
    }
    ...
    if (_expversion & POST_BC_EXP_FLAG || (_expversion & POST_WOTLK_EXP_FLAG))                     // only 2.x and 3.x clients
