            ...
            if (ClassCall_Timer <= diff)
            {
                ...
                switch (urand(0, 8))
                {
                    ...
                    case 1:
                        ...
                        //DoCast(me, SPELL_WARRIOR); жестокий баг, потом придумаю как фиксануть, комментирую, а то забуду.
                        break;
                    case 2:
                        DoScriptText(SAY_DRUID, me);
                        //DoCast(me, SPELL_DRUID); жестокий баг, потом придумаю как фиксануть, комментирую, а то забуду.
                        break;
                    case 3:
